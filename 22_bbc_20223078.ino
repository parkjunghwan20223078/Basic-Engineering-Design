...
int duty_target;    // Target duty 목표 각도
int duty_curr;      // Current duty 현재 각도
...
void loop() {
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(2, 0.5)); // Replace n with your desired value
...
// output the read value to the serial port
    ...
    Serial.print(",duty current: "); Serial.println(duty_curr);
  }
}
...
//  return (6762.0 / (a_value - 9) - 4.0) * 10.0;
    return  655 + -2.22*a_value + 1.86*pow(10,-3)*pow(a_value,2);
}
